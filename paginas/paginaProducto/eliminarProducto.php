...
<body>
    ...
    <div class="container sm">
        <form class="Formulario" action="/paginas/paginaProducto/eliminado/eliminar.php" method="POST"
            enctype="multipart/form-data">
            <center>
                <img class="mb-4" src="/imagenes/logo.png" alt="" width="60" height="60">
                 <h1 class="h3 mb-3 fw-normal text-danger">Esta seguro de eliminar este producto</h1>
                <input type="text" class="w-80 btn btn-lg btn-dark" name="codigo" value="<?php echo $codigoProdu ?>">
                <br><br>
            </center>
            <b class="b1">Nombre:</b>
            <input type="text" class="form-control" id="" name="nombreProducto" value="<?php echo $nombreProdu ?>"
                placeholder="Nombre del producto" disabled>
            <br>
            <b class="b1">Proveedor:</b>
            <input type="text" class="form-control" id="" name="provedor" value="<?php echo $proveedorProduc ?>"
                placeholder="Nombre del proveedor"disabled>
            <br>
            <b class="b1">Fecha de vencimiento:</b>
            <br>
            <input type="date" class="form-control" id="" name="fechavencimiento"
                value="<?php echo $fechavencimientoProduc ?>"disabled>
            <br>
            <b class="b1">Precio:</b>
            <input type="number" class="form-control" id="" name="preciounitario" value="<?php echo $precioProduc ?>"
                placeholder="Precio unitario"disabled>
            <br>
            <b class="b1">Cantidad:</b>
            <input type="number" class="form-control" id="" name="cantidad" value="<?php echo $cantidadProdu ?>"
                placeholder="Cantidad"disabled>
            <br>
            <b class="b1">Descripción:</b>
            <input type="text" class="form-control" id="" name="descripcion" value="<?php echo $descripcionProduc ?>"
                placeholder="Cantidad" disabled>
            <br>
            <b class="b1">Anterior actual:</b>
            <center>
           ...
           <center>
                ...
                echo "<a href='/paginas/paginaProducto/producto.php?codigoE=1'> <input type ='button' class='btn btn-lg btn-success' value = 'No'></input></a>";   
                ?>
                </div>
            </center>  
            <center>
