...
<body>
    ...
    <div class="container sm">
        <form class="Formulario" action="/paginas/paginaTrabajador/altastrabajador.php" method="POST"
            enctype="multipart/form-data">
            <center>
                <img class="mb-4" src="/imagenes/logo.png" alt="" width="60" height="60">
            </center>
            <h1 class="h3 mb-3 fw-normal text-center">Agregar nuevo trabajador</h1>
            <input type="text" class="form-control" id="" name="nombreTrabajador" placeholder="Nombre del trabajador"
                required>
            <br>
            <input type="number" class="form-control" id="" name="telefono" placeholder="telefono" required>
            <br>
            <input type="number" class="form-control" id="" name="ci" placeholder="C.I"
                required>
            <br>
            <input type="correo" class="form-control" id="" name="correo" placeholder="usuario@gmail.com" required>
            <br>
