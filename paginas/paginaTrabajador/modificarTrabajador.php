...
<body>
    ...
    <div class="container sm">
        <form class="Formulario" action="/paginas/paginaTrabajador/modificando/modificar.php" method="POST"
            enctype="multipart/form-data">
            <center>
                <img class="mb-4" src="/imagenes/logo.png" alt="" width="60" height="60">
                 <input type="text" class="w-80 btn btn-lg btn-dark" name="codigo" value="<?php echo $codigoTrabajador ?>">
                <br><br>               
            </center>
            <h1 class="h3 mb-3 fw-normal text-center">Modificar trabajador</h1>
            <b class="b1">Nombre:</b>
            <input type="text" class="form-control" id="" name="nombreTrabajador" value="<?php echo $nombreTrabajador ?>" placeholder="Nombre del trabajador"
                required>
            <br>
            <b class="b1">Telefono:</b>
            <input type="number" class="form-control" id="" name="telefono" value="<?php echo $telefonoTrabajador ?>" placeholder="telefono" required>
            <br>
            <b class="b1">C.I</b>
            <input type="number" class="form-control" id="" name="ci" value="<?php echo $ciTrabajador ?>" placeholder="C.I" required>
            <br>
            <b class="b1">Correo:</b>
            <input type="correo" class="form-control" id="" name="correo" value="<?php echo $correoTrabajador ?>" placeholder="usuario@gmail.com" required>
            <br>
            <button class="w-100 btn btn-lg btn-info" type="submit">Modificar</button>
            <center>
