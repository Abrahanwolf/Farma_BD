...
<body>
    ...
    <div class="container sm">
        <form class="Formulario" action="/paginas/paginaModificar/modificarCuenta.php" method="POST">
            <center>
                <img class="mb-4" src="/imagenes/logo.png" alt="" width="60" height="60">
                <h1 class="h3 mb-3 fw-normal">Modificar cuenta</h1>
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" id="" name="apellidopaterno"
                    value="<?php echo $apellidopUser ?>" placeholder="Apellido paterno" disabled required>
                <input type="text" class="form-control" id="" name="apellidomaterno"
                    value="<?php echo $apellidomUser ?>" placeholder="Apellido materno" disabled required>
            </div>
            <b>Ciudad:</b>
            <select class="form-select" name="ciudad" disabled>
                <?php
                echo $ciudadUser;
            ...
            <input type="text" class="form-control" id="" name="direccion" value="<?php echo $direccionUser ?>"
                placeholder="Ingrese su dirección" disabled required>
            <br>
            <b>Telefono:</b>
            <input type="number" class="form-control" id="" name="telefono" value="<?php echo $telefonoUser ?>"
                placeholder="Ingrese su telefono" disabled required>
            <br>
            ...
            <center>
                ...
                <?php
                echo "<a href='/paginas/paginaLogin/cuentaModificar?codigoE=$codigoUser'> <input type ='button' class='btn btn-lg btn-success' value = 'Modificar'></input></a>";   
                echo "<a href='/paginas/paginaLogin/cuentaEliminar?codigoE=$codigoUser'> <input type ='button' class='btn btn-lg btn-danger' value = 'Eliminar'></input></a>";   
                ?>
                </div>
            </center>
