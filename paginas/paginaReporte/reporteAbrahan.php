...
<body>
    ...
    <div class="container sm">
        <form class="Formulario" action="InformacionReporte3.php" method="POST">
            <center>
                <img class="mb-4" src="/imagenes/logo.png" alt="" width="60" height="60">
            </center>
            <h1 class="h3 mb-3 fw-normal text-center">Reporte por nombre de producto</h1>
            <br>
            <b>Nombre productos:</b>
             <br>
            <select class="form-select" name="nombreproducto">
                <?php
